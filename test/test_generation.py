...
class TestGeneration(unittest.TestCase):
    ...
    def test_path_parsing(self):
        ...
        for string, expected_answer in zip(path_strings, expected_answers):
            answer = parse_path(string).d()

            expected_answer2 = expected_answer
            if isinstance(expected_answer, tuple):
                expected_answer2 = expected_answer[1]
                expected_answer = expected_answer[0]

            option1 = answer == expected_answer
            option2 = answer == expected_answer2

            msg = ('\nstring = {}\nanswer = {}\n \na1     = {}\na2     =\n{}'
                   ''.format(string, answer, expected_answer, expected_answer2))
    ...
    def test_normalizing(self):
        ...
        expected_answer = "M 0,0 L 340,-10 L 100,100 M 100,100 L 200,0"
        self.assertTrue(parse_path(string).d() == expected_answer)
